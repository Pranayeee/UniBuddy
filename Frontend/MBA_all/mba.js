document.addEventListener("DOMContentLoaded", function () {
     ...
     fetch("http://localhost:5003/api/mba-colleges")
          ...
          .then(data => {
               colleges = data.map(college => {
                    ...
                    card.innerHTML = `
                     <div class="card text-dark bg-white mb-3" style="width:99%">
                         <div class="card-body">
                             ...
                             <button class="google-search-btn btn btn-success" onclick="searchGoogle(event)">Search on Google</button>
                         </div>
                     </div>
                 `;
